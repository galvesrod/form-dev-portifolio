...
export default function Principal(props: PrincipalProps){
    return (
        <div className="
                flex flex-col items-center justify-center h-125
            ...
            <div className="flex-1 flex flex-col justify-center items-center gap-5 w-full">
                <div className="flex flex-col gap-1 items-center">
                    <h1 className="flex gap-3 items-center">
                        ...
                        <span className="text-3xl sm:text-5xl font-bold text-center">Gabriel Alves</span>
                        <span className="w-2 h-2 rounded-full bg-red-500"></span>
                    </h1>
                    <h2 className="text-zinc-500 text-center">Estudando desenvolvimento</h2>
                </div>
